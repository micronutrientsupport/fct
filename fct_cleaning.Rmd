...
This data is coming from Joy et al. (2014) study. We have reformated and added the "GENuS" code to each food item, together with the confidence in the matches between the food items that represented and the food items chosen. 
...
3- The "middle region" food composition table is a exact copy of the "western region" fct, hence when possible and available data for that region should be generated. 
