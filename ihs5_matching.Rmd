...
Below are the comments to be solved:
 ...
 2) 412 - Tinned vegetables (specify) change to Tinned beans. = Tinned, beans (MW02_0003)
 3) 106 - rice was duplicated --> Fixed. 
 4) 829 - restaurant meals ---> Nsima (MW01_0031) - check min values for this recipe, chicken (MW03_0010), rape leaves, boiled (MW04_0020*Retention factor)

-Recalculate min values for all sweet potato using Edward
 5) 832 and 831 - Add b) version w/ orange 
 6) 816 - Change compo to candies
 7) 204 - OFSP
 8) 203 - WFSP
