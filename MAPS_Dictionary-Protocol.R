...
#Manual inputs:
food_desc <- c("cheese, cow milk, cheddar",
          "cheese, cow milk, skimmed, cottage",
          "cheese, cow milk, whole, cottage")
...
scientific_name <- c(NA, NA, NA, NA, NA, NA, NA)
other_name <- c(NA, NA, NA, NA, NA, "bicarbonate of soda", NA)
